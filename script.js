...
bg.addEventListener("mouseover", function (e) {
  ...
  boxdiv.innerHTML =
    "<div class='newdiv'><div id='box-1' style='border-radius:3px; width: 75px; height: 75px; position: relative; top: -270px; left: 220px; z-index: 2'></div><div id='box-2' style='border-radius:3px; width: 75px;height: 75px; position: relative;top: -325px;left: 30px;z-index: 3;'> </div><div id='box-3' style='border-radius:3px; width: 75px;height: 75px;position: relative;top: -275px;left: 115px;z-index: 3;'></div></div>";
  ...
  boxdiv.addEventListener("mouseover", function (e) {
    if (e.target.id === "box-1") {
      ...
      box2.style.backgroundColor = "rgba(252, 191, 116, 0.8)";
      box2.innerHTML =
        "<h4 id='box-2-text' style='padding: 3px' >Graphic Design</h4>";
    } else if (e.target.id === "box-3") {
      box3.style.backgroundColor = "rgba(247, 92, 169, 0.8)";
      box3.innerHTML =
        "<h4 id='box-3-text' style='padding: 5px; padding-top: 50px; font-size:18px; color:rgb(0,0,0);'>More</h4>";
    }
