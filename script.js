...
boxes.addEventListener(
  ...
  (someFunc = (e) => {
    ...
    if (e.target.id === "box-1") {
      aboutme.innerHTML =
        "<p>I researched crypto and NFT content on YouTube, tiktok and Twitter and published TikToks based on my research. The Tik Toks performed quite well and in 3 months, Tiktok follower growth hit 1,000 followers, with TikToks having an average 3,000-5,000 views. Example: https://www.tiktok.com/@coinstore_global/video/7034423185898573057 Researched trends within the crypto space to create TikToks which received thousands of views within 2-3 days - with no paid advertising, purely on organic followers</p>";
